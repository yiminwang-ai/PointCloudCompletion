...
import unified_engine.shapenet_part_loader
...
if __name__=="__main__":
    ...
    parser.add_argument('--netG', default='Models/point_netG45.pth', help="path to netG (to continue training)")
    parser.add_argument('--netD', default='Models/point_netD45.pth', help="path to netD (to continue training)")
    ...
    test_dset = unified_engine.shapenet_part_loader.PartDataset( root='./shape_data/',classification=True, class_choice=None, npoints=opt.pnum, split='test')
    ...
    for i, data in enumerate(test_dataloader, 0):
        ...
        real_point = torch.unsqueeze(real_point, 1)#batch,1,pnum,3
    ...
    #    p_center  = real_point[0,0,index]
        ...
        p_center = index
        distances = torch.sum((real_point[0, 0] - p_center) ** 2, dim=1)
