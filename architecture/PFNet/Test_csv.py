...
parser.add_argument('--dataroot',  default='shape_data', help='path to dataset')
...
parser.add_argument('--netG', default='Checkpoint/mini_model/point_netG5.pth', help="path to netG (to continue training)")
...
parser.add_argument('--netD', default='Checkpoint/mini_model/point_netD5.pth', help="path to netD (to continue training)")
...
test_dset = shapenet_part_loader.PartDataset( root='./shape_data/',classification=True, class_choice='Car', npoints=opt.pnum, split='test')
