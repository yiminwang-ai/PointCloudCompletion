...
class GeneralTrainEngine(TrainEngine):
...
class GeneralTestEngine(TestEngine):
    def __init__(self, model,model_path, test_dataloader: DataLoader):
        super().__init__(model_path, test_dataloader)
        self.model=model
