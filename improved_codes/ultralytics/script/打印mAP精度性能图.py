...
title = "YOLOv8-改进模型和其他YOLO模型mAP对比"
...
plt.plot(x, y, label='Our(YOLOv8改进版)', marker = 'o',linewidth =2.0, color='red')

plt.text(x[0],y[0], '改进版YOLOv8-S',c='black')
plt.text(x[1],y[1], '改进版YOLOv8-M',c='black')
plt.text(x[2],y[2], '改进版YOLOv8-L',c='black')
plt.text(x[3],y[3], '改进版YOLOv8-X',c='black')
