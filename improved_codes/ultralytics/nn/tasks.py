...
from ultralytics.nn.modules.CoreV8.Backbone.HGNetv2 import C2f_HGNetv2, C3_HGNetv2, CPNHGNetv2, CSCHGNetv2, ReNLANHGNetv2
from ultralytics.nn.modules.CoreV8.Backbone.UniRepLK import C2f_UniRepLK, C3_UniRepLK, CPNUniRepLK, CSCUniRepLK, ReNLANUniRepLK
from ultralytics.nn.modules.CoreV8.Backbone.LSK import C2f_LSK, C3_LSK, CPNLSK, CSCLSK, ReNLANLSK
...
from ultralytics.nn.modules.CoreV8.Conv.arconv import CARC
...
from ultralytics.nn.modules.CoreV8.Backbone.PvT import CSC_PvT, ReNLAN_PvT, C3_PvT, C2f_PvT, CPN_PvT
from ultralytics.nn.modules.CoreV8.Backbone.ema import EMA
...
from ultralytics.nn.modules.CoreV8.dcnv4 import CKDCNv4

from ultralytics.nn.modules import CARAFE
from ultralytics.nn.modules.CoreV8.Attention.mlla import LinearAtt
...
from ultralytics.nn.modules.CoreV8.uav import DySample_,SPDConv,MFFF,FrequencyFocusedDownSampling,SemanticAlignmenCalibration, BottleNeck, BasicBlock_
from ultralytics.nn.modules.CoreV8.uav_block import ConvNormLayer, Blocks, RepC3_
from ultralytics.nn.modules.CoreV8.Conv.PinwheelConv import PinwheelCB
from ultralytics.nn.modules.CoreV8.Conv.scconv import SCBottleneck
from ultralytics.nn.modules.CoreV8.Backbone.repvit import RepVB

from ultralytics.nn.modules.CoreV8.Backbone.dcnv3 import CDCNv3
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in (
            ...
            args = [c1, c2, *args[1:]]
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3, C3k2, C2PSA):
            ...
            if m in [FasterNeXt, CSCFasterNeXt, C3_FasterNeXt, C2f_FasterNeXt]:
                args.insert(2, n)  # number of repeats
                n = 1
        elif m in [CPNGhost, CSCGhost, CARC, ReNLANGhost, C3_Ghost, C2f_Ghost]:
            c1, c2 = ch[f], args[0]
            if c2 != nc:  # if not output
                c2 = make_divisible(min(c2, max_channels) * width, 8)
            args = [c1, c2, *args[1:]]
            if m in [CPNGhost, CSCGhost, CARC, C3_Ghost, C2f_Ghost]:
                args.insert(2, n)  # number of repeats
                n = 1
        ...
        #     args = [c1, c2, *args[1:]]
            ...
            if c2 != nc:  # if not output
                c2 = make_divisible(min(c2, max_channels) * width, 8)
            args = [c1, c2, *args[1:]]
        elif m in [CSC_PvT, ReNLAN_PvT, C3_PvT, C2f_PvT, CPN_PvT]:
            c1, c2 = ch[f], args[0]
            if c2 != nc:  # if not output
                c2 = make_divisible(min(c2, max_channels) * width, 8)
            args = [c1, c2, *args[1:]]
            if m in [CSC_PvT, C3_PvT, C2f_PvT, CPN_PvT]:
                args.insert(2, n)  # number of repeats
                n = 1
        ...
        # 新增模块======================
            ...
            c2 = sum(ch[x] for x in f)
        elif m in (Detect, Segment, Pose, OBB, v10Detect):
