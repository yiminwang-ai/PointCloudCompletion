...
def bbox_multi_iou(box1, box2, xywh=False, GIoU=False, DIoU=False, CIoU=False, EIoU=False, SIoU=False, WIoU=False, EfficiCIoU=False, XIoU=False, SDIoU=False, is_Focaler='None', eps=1e-7):
    """
